  ...
  rules: [
    ...
    },
    {
      ...
      transform: (content) => {
        ...
        return content
          ...
          .replaceAll('* <=', '* &lt;=')
          .replaceAll('「<>」', '「&lt;&gt;」')
          .replaceAll('IF(AND(学科>=80,実技>=80),"合格","再テスト")', 'IF(AND(学科&gt;=80,実技&gt;=80),"合格","再テスト")')
          .replaceAll('IF(OR(学科>=80,実技>=80),"合格","再テスト")', 'IF(OR(学科&gt;=80,実技&gt;=80),"合格","再テスト")')
          .replaceAll('IF(NOT(学科+実技>=160),"再テスト","合格")', 'IF(NOT(学科+実技&gt;=160),"再テスト","合格")')
          .replaceAll('IF(AND(入社年月日!="",退職年月日=""),1,0)', 'IF(AND(入社年月日!="",退職年月日=""),1,0)');
      }
    },
    {
    ...
    },
    {
      ...
      transform: (content) => {
        ...
        return content
          .replaceAll('<a href=/k/ja/id/040628.html>', '<a href="/k/ja/id/040628.html">');
      }
    }
  ],
};
